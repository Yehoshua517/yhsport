          ...
          <div class="text-center lg:text-left">
            <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                Hi, I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500">
                 Josué K. AYITEY (Yehoshua)
                </span>
            </h1>
          </div>
          <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
            Fort de trois ans d'expérience, je m'engage à rester à la pointe
            des nouvelles technologies et à fournir des solutions innovantes dans le domaine de l'ingénierie logicielle en
            perpétuelle évolution. Je nourris également une passion grandissante pour l’univers de
          ...
          <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
              <button class="px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                  ...
                  <span class="relative flex items-center justify-center text-white">                  
                    <a href="tel:+22891112541"> M'embaucher</a>
                  </span>
              </button>
              <button class=" border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                  ...
                  <a href="src/assets/Josue_Ayitey_CV_2025_FR.pdf" download="Josue_Ayitey_CV_2025.pdf" class="pl-2 text-primary"> Mon CV</a>
                  </div>
              </button>
          </div>
      </div>
